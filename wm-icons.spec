...
Summary(pl):	Window Manager Icons, konfigurowalny zbiór ikon
Name:		wm-icons
Version:	0.3.0
Release:	1
License:	GPL
...
standaryzacji i konfigurowania. Posiada parê tematycznych zestawów
ikon, skrypty i konfiguracjê dla kilku menad¿erów okien.
